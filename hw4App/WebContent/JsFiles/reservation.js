...
function create(h3_text,h5_text,img_source_path){
	...
	var forname =  "res_" + h3_text;
    form.setAttribute("name", forname); 
	form.setAttribute("id", forname); 
    form.setAttribute("action", "res_pick_store"); 
	var myinput = document.createElement("INPUT");
	myinput.setAttribute("type", "hidden");
	myinput.name = "res_store";
	...
	var str = "pickedStore(" + "'" + "res_" + h3_text + "'" + ")" + ";";
...
function pickedStore(formname){
	var form = document.getElementById(formname);
	form.action="res_pick_store";
	form.submit();
}